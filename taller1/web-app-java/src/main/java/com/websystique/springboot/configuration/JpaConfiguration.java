...
public class JpaConfiguration {
	...
	@Value("${spring.jpa.maxPoolSize:10}")
	...
	private Properties jpaProperties() {
		...
		if (StringUtils.isNotEmpty(environment.getRequiredProperty("spring.jpa.defaultSchema"))) {
			properties.put("hibernate.default_schema", environment.getRequiredProperty("spring.jpa.defaultSchema"));
		}
		return properties;
	}
